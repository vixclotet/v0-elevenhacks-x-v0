// Inline SVG brand logos — zero external dependencies, always render correctly.
// Each logo is rendered exactly as it appears in the official brand image provided.
...
export function LululemonLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 200 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="lululemon" {...props}>
      {/* Swirl icon */}
...
export function NikeLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 200 80" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Nike" {...props}>
...
export function GoogleLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Google" {...props}>
...
export function DropboxLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 220 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Dropbox" {...props}>
      {/* Diamond icon */}
...
export function NetflixLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 111 30" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Netflix" {...props}>
...
export function FacebookLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 140 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Facebook" {...props}>
      {/* Circle F icon */}
...
export function MicrosoftLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 200 44" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Microsoft" {...props}>
      {/* 4-square grid */}
...
export function GitHubLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 160 44" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="GitHub" {...props}>
      {/* Octocat simplified */}
...
export function SpotifyLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 168 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Spotify" {...props}>
...
export function ShopifyLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Shopify" {...props}>
      {/* Bag icon */}
...
export function SlackLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 155 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Slack" {...props}>
      {/* Simplified hashtag grid icon */}
...
export function AirbnbLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 165 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Airbnb" {...props}>
...
// Map brand name → component for convenience
...
// Ordered list matching the provided carousel image exactly
...
// Extended set for the second carousel track
