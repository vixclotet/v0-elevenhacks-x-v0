...
const products = [
  ...
  },
  {
    ...
    description: "Up to 7 custom stickers in a retail-ready pack — perfect for shops, gifts, and events",
    price: "From $49",
    badge: "Popular",
    ...
    imageAlt: "Sticker Packs branded image showing two packaged sticker packs with Do A Kickflip and burger stickers",
    badgeColor: "bg-accent text-accent-foreground",
  },
  {
    name: "Keychains",
    description: "Acrylic keychains with a protective film — your design on a carry-anywhere accessory",
    price: "From $59",
    badge: "New",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sm-keychains4-KHF95C6OZBSRs9yP3q6lslbDdE2tj4.jpg",
    imageAlt: "Sticker Mule custom keychain featuring a monkey skateboarding with protective film instruction card",
    badgeColor: "bg-yellow-500 text-foreground",
  },
  {
